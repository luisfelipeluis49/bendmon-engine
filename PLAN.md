...
Status: M0 bootstrap/feasibility, M1 architecture, M2 Content-0, M3 headless battle and M4 effect algebra are complete and verified locally and through hosted Ubuntu CI. M5 multi-type attacks pass the full local gate and await hosted closure. On 2026-09-21 the owner approved every remaining recommended decision, including the R01–R13 and U01–U13 closures. No currently identified owner-choice blocker remains; future changes use explicit ruleset versioning. Fixed requirements and approved defaults are recorded in `docs/DECISIONS.md`.
...
| M5 Multi-type attacks | **Implemented locally:** engine-owned ten-type chart, authored-order 1–4 component list, canonical quotient/remainder allocation, exact per-component STAB/type math and checked aggregation | M4; rounding/STAB/damage decisions approved | Luna implementation and fixtures | Independent Luna contract review; production-linked 1/2/3/4-component examples, laws and native/JavaScript equality |
| M6 Mix / discovery / harmony | Explicit recipes, atomic source engagement, observation, training, individual harmony | M5; all relevant D05–D10 decisions approved | Luna implementation and approved sample recipes | Independent Luna review; MIX-1–8 and learning tests/proofs |
| M7 Progression / capture / inventory | XP/stats/levels 1–200, learning/evolution, capture, party/storage, bounded inventory and shop transactions | M4; may run alongside M5–6; D11–D13 approved | Luna implementation and fixtures | Luna rules review; boundary/generated tests, atomic capture/inventory transactions |
