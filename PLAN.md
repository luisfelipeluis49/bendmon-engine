...
Status: M0 bootstrap/feasibility, M1 architecture, M2 Content-0, M3 headless battle, M4 effect algebra and M5 multi-type attacks are complete and verified locally and through hosted Ubuntu CI. On 2026-09-21 the owner approved every remaining recommended decision, including the R01–R13 and U01–U13 closures. No currently identified owner-choice blocker remains; future changes use explicit ruleset versioning. Fixed requirements and approved defaults are recorded in `docs/DECISIONS.md`.
...
| M6 Mix / discovery / harmony | **In progress:** production mixed battle, roster learning, catalog-checked identity codec, authored mix metadata and native/JS edge differential pass focused checks; M4 program binding, queued blocked edges, broader proofs and final hosted gate remain | M5; all relevant D05–D10 decisions approved | Luna implementation and approved sample recipes | Independent Luna review; MIX-1–8 and learning tests/proofs |
