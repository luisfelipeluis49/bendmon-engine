...
| M6 Mix / discovery / harmony | **Prepared, not started:** explicit recipes, atomic source engagement, observation, training, individual harmony; frozen work package in `docs/work-orders/M6-MIX-DISCOVERY-HARMONY.md` | M5; all relevant D05–D10 decisions approved | Luna implementation and approved sample recipes | Independent Luna review; MIX-1–8 and learning tests/proofs |
