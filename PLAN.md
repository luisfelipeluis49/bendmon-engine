...
| M6 Mix / discovery / harmony | **In progress:** recipe catalog, pure discovery/training/Harmony and two-source transaction started; battle execution, replay and full gate remain | M5; all relevant D05–D10 decisions approved | Luna implementation and approved sample recipes | Independent Luna review; MIX-1–8 and learning tests/proofs |
