...
| M4 Effect algebra | **Implemented locally:** closed typed effect interpreter and representative physical/special/status/heal/buff/conditional moves, status lifecycle and atomic validation/fault boundary | M3; stacking/failure semantics approved | Sol; deterministic fixtures | Production-linked law gate, effect-order goldens and native/JavaScript differential execution |
