...
| M6 Mix / discovery / harmony | **In progress:** production mixed battle, roster learning, exact identity codec, base-move schema and native/JS differential pass focused checks; queued edge oracles, full schema/proofs and latest hosted gate remain | M5; all relevant D05–D10 decisions approved | Luna implementation and approved sample recipes | Independent Luna review; MIX-1–8 and learning tests/proofs |
