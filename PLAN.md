...
| M4 Effect algebra | **Implemented locally:** closed typed effect interpreter; normal runtime/replay integration; representative physical/special/status/heal/buff/conditional moves; status lifecycle; atomic validation/fault boundary | M3; stacking/failure semantics approved | Luna implementation and fixtures; independent Luna review | 137-check local gate, production-linked laws, effect/runtime/replay goldens and native/JavaScript differential execution; hosted gate pending |
