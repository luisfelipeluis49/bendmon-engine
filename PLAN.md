...
| M6 Mix / discovery / harmony | **In progress:** recipe/learning core and first production mixed battle/ledger path pass locally; runtime replay differential, full schema/proofs and hosted gate remain | M5; all relevant D05–D10 decisions approved | Luna implementation and approved sample recipes | Independent Luna review; MIX-1–8 and learning tests/proofs |
